...
internal class CreateResponseSerializationTest {

    private val response = MpCreateResponse(
        responseId = "id-1",
        errors = listOf(
            ErrorDto(
                code = "ERROR-CODE",
    ...
    fun serializationTest() {
        ...
        val responseAsString = json.encodeToString(MpCreateResponse.serializer(), response)
    ...
    fun deserializationTest() {
        ...
        val respEntity = Json.decodeFromString(MpCreateResponse.serializer(), json)
